...
public class BufferCircularMonitores<E>
        extends BufferCircularBaseImpl<E> {
    ...
    public synchronized E get() throws InterruptedException {
        ...
        // Atualizar o próximo índice de get (posição de onde se obtem o próximo elemento)
        ++this.idxGet;
    ...
    public AtomicInteger getNumElements() { return this.numElements; }
}
